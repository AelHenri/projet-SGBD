...
def recettes(Id_recette, error=None):
	cursor = mysql.connect().cursor()
	...
	return render_template('recette.html', recette=recette, auteur=auteur, ingredients=ingredients, commentaires=commentaires, avis=avis, notes=notes, nbavis=NbAvis,mess=None)
